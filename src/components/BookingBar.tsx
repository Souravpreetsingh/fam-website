...
export function CalendarPopover({
  ...
  return (
    <motion.div
      ...
      className={`absolute ${dropdownUp ? 'bottom-full left-0 mb-2' : 'top-full left-0 mt-2'} w-[280px] p-4 rounded-2xl z-50
...
export function GuestPopover({
  adults, children, onChangeAdults, onChangeChildren, dropdownUp = true,
}: {
  ...
  return (
    <motion.div
      ...
      exit={{ opacity: 0, y: 8, scale: 0.96 }}
      transition={{ duration: 0.2, ease: 'easeOut' }}
      className={`absolute ${dropdownUp ? 'bottom-full left-0 mb-2' : 'top-full left-0 mt-2'} w-[220px] p-4 rounded-2xl z-50
        bg-white/[0.08] backdrop-blur-[24px] border border-white/12
        shadow-[0_12px_48px_rgba(0,0,0,0.3),0_4px_16px_rgba(0,0,0,0.15)]`}
    >
...
export const NIGHTLY_RATE = 6000
